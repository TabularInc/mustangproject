...
public abstract class Validator {
	 ...
	 * @throws IrrecoverableValidationError when any fatal errors arise, e.g. when
	 ...
	 * 
	 * @throws IrrecoverableValidationError any fatal errors, e.g. when the source
	...
	/***
	 * validates a schema, which can only be needed in XML validation - and in pdf
	 * validation for additional data
	 * 
