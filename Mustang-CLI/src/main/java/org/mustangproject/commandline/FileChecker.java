...
public class FileChecker {
	...
	public boolean checkForZUGFeRD() {
		...
		try {
			 ...
			 * at
			 * org.mustangproject.ZUGFeRD.ZUGFeRDImporter.extractLowLevel(ZUGFeRDImporter.java:90)
			 * at
			 * org.mustangproject.ZUGFeRD.ZUGFeRDImporter.extract(ZUGFeRDImporter.java:64)
