...
import org.tabular.mustangproject.*;
...
import org.tabular.mustangproject.ZUGFeRD.ZUGFeRDImporter;
import org.tabular.mustangproject.ZUGFeRD.ZUGFeRDInvoiceImporter;
import org.tabular.mustangproject.ZUGFeRD.model.DocumentCodeTypeConstants;
import org.tabular.mustangproject.ZUGFeRD.model.EventTimeCodeTypeConstants;
...
public class ZF2PushTest extends TestCase {
	...
	public void testPushExport() {
		/***
		 * This writes to a filename like an official sample, please consider when
		 * changing (probably better not?)
		 */
		// the writing part
		...
		try {
			...
			ze.setTransaction(new Invoice().setDueDate(new Date()).setIssueDate(new Date()).setDeliveryDate(new Date())
					.setSender(new TradeParty(orgname, "teststr", "55232", "teststadt", "DE").addTaxID(taxID).addVATID("DE0815")
							.setDescription(senderDescription))
					.setRecipient(new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "DE").addVATID("DE4711")
							.setContact(new Contact("Franz Müller", "01779999999", "franz@mueller.de", "teststr. 12", "55232",
									"Entenhausen", "DE")))
					.setNumber(number)
					.addItem(new Item(
							new Product("Testprodukt", "", "C62", new BigDecimal(0))
									.setTaxExemptionReason("Kleinunternehmer gemäß §19 UStG").setTaxCategoryCode("E"),
	...
	public void testBankTransferExport() {
		...
		try {
			...
			ze.setTransaction(new Invoice().setDueDate(new Date()).setIssueDate(new Date()).setDeliveryDate(new Date())
					.setSender(new TradeParty(orgname, "teststr", "55232", "teststadt", "DE").addBankDetails(bd).addTaxID(taxID)
							.addVATID("DE0815"))
					.setRecipient(new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "DE").addVATID("DE4711")
							.setContact(new Contact("Franz Müller", "01779999999", "franz@mueller.de", "teststr. 12", "55232",
									"Entenhausen", "DE")))
			...
			ZUGFeRDInvoiceImporter zii = new ZUGFeRDInvoiceImporter(
					new ByteArrayInputStream(theXML.getBytes(StandardCharsets.UTF_8)));
	...
	public void testItemChargesAllowancesExport() {
		...
		try {
			...
			ze.setProducer("My Application").setCreator(System.getProperty("user.name")).setZUGFeRDVersion(2)
					.setProfile("extended");
			// ze.setTransaction(new Invoice().setDueDate(new Date()).setIssueDate(new
			// Date()).setDeliveryDate(new Date()).setSender(new
			// TradeParty(orgname,"teststr",
			// "55232","teststadt","DE")).setOwnTaxID("4711").setOwnVATID("DE0815").setRecipient(new
			// TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen",
			// "DE")).setNumber(number)
			// .addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)),
			// amount, new BigDecimal(1.0)).addAllowance(new Allowance().setPercent(new
			// BigDecimal(50)))));
			...
			ze.setTransaction(new Invoice().setDueDate(new Date()).setIssueDate(new Date())
					...
					.setRecipient(new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "DE")
							.setContact(
									new Contact("contact testname", "123456", "contact.testemail@example.org").setFax("0911623562")))
					.setNumber(number)
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)), amount, new BigDecimal(1.0))
							.addAllowance(new Allowance(new BigDecimal("0.1"))))
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)), amount, new BigDecimal(1.0))
							.addAllowance(new Allowance().setPercent(new BigDecimal(50))))
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)), amount, new BigDecimal(2.0))
							.addCharge(new Charge(new BigDecimal(1))))
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)), amount, new BigDecimal(1.0))
							.addCharge(new Charge(new BigDecimal(1))).addAllowance(new Allowance(new BigDecimal("1")))));
			...
			ze.setTransaction(new Invoice().setDueDate(new Date()).setIssueDate(new Date()).setDeliveryDate(new Date())
					...
					.setRecipient(new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "DE").addVATID("DE0816")
							.setContact(
									new Contact("contact testname", "123456", "contact.testemail@example.org").setFax("0911623562")))
					.setDeliveryAddress(
							new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "DE").addVATID("DE0816"))
					.setNumber(number)
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)).setIntraCommunitySupply(), amount,
							new BigDecimal(1.0)))
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)).setIntraCommunitySupply(), amount,
							new BigDecimal(1.0)))
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)).setIntraCommunitySupply(), amount,
	...
	/**
	 * or manually, in which case the transaction needs a delivery address outside
	 * DE, and the items a 0 tax with reason K and reason code
	 */
	...
	public void testIntraCommunitySupplyManualExport() {
		...
		try {
			...
			ze.setTransaction(new Invoice()
					.setDeliveryAddress(new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "FR"))
					.setDueDate(new Date()).setIssueDate(new Date()).setDeliveryDate(new Date())
					.setSender(new TradeParty(orgname, "teststr", "55232", "teststadt", "DE").addTaxID(taxID).addVATID("DE0815"))
					.setRecipient(new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "FR").addVATID("DE4711")
							...
							.setContact(new Contact("Franz Müller", "01779999999", "franz@mueller.de", "teststr. 12", "55232",
									"Entenhausen", "DE")))
					.setNumber(number)
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(0))
							.setTaxExemptionReason("Kein Ausweis der Umsatzsteuer bei innergemeinschaftlichen Lieferungen")
							.setTaxCategoryCode("K"), price, new BigDecimal(1.0))));
			String theXML = new String(ze.getProvider().getXML());
			assertTrue(theXML.contains("<rsm:CrossIndustryInvoice"));
			...
			ze.setTransaction(new Invoice().setDueDate(new Date()).setIssueDate(new Date()).setDeliveryDate(new Date())
					...
					.setRecipient(new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "DE").addVATID("DE0816")
							.setContact(
									new Contact("contact testname", "123456", "contact.testemail@example.org").setFax("0911623562")))
					.setNumber(number)
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)).setReverseCharge(), amount,
							new BigDecimal(1.0)))
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)).setReverseCharge(), amount,
							new BigDecimal(1.0)))
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)).setReverseCharge(), amount,
	...
	public void testChargesAllowancesExport() {
		...
		try {
			...
			ze.setTransaction(new Invoice().setCurrency("CHF").setDueDate(new Date()).setIssueDate(new Date())
	...
	public void testPushEdge() {
		...
		try {
			...
			try {
				...
				ze.setTransaction(new Invoice().setCurrency("CHF").addNote("document level 1/2").addNote("document level 2/2")
						.setDueDate(new Date()).setIssueDate(new Date()).setDeliveryDate(new Date())
						.setSellerOrderReferencedDocumentID("9384").setBuyerOrderReferencedDocumentID("28934")
						.setDetailedDeliveryPeriod(new SimpleDateFormat("yyyyMMdd").parse(occurrenceFrom),
								new SimpleDateFormat("yyyyMMdd").parse(occurrenceTo))
						.setSender(new TradeParty(orgname, "teststr", "55232", "teststadt", "DE").addTaxID(taxID)
								.setEmail("sender@test.org").setID(orgID).addVATID("DE0815"))
						.setDeliveryAddress(
								new TradeParty("just the other side of the street", "teststr.12a", "55232", "Entenhausen", "DE")
										.addVATID("DE47110"))
						.setContractReferencedDocument(contractID)
						.setRecipient(new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "DE").addGlobalID(gln)
								.setEmail("recipient@test.org").addVATID("DE4711")
								.setContact(new Contact("Franz Müller", "01779999999", "franz@mueller.de", "teststr. 12", "55232",
										"Entenhausen", "DE").setFax("++49555123456"))
								.setAdditionalAddress("Hinterhaus 3"))
						.addItem(new Item(
								new Product("Testprodukt", "", "C62", new BigDecimal(16)).addGlobalID(gtin).setSellerAssignedID("4711"),
								price, new BigDecimal(1.0))
								.addReferencedLineID("xxx").addNote("item level 1/1")
								.addAllowance(
										new Allowance(new BigDecimal(0.02)).setReason("item discount").setTaxPercent(new BigDecimal(16)))
								.setDetailedDeliveryPeriod(sdf.parse("2020-01-13"), sdf.parse("2020-01-15")))
						.addCharge(
								new Charge(new BigDecimal(0.5)).setReason("quick delivery charge").setTaxPercent(new BigDecimal(16)))
						.addAllowance(new Allowance(new BigDecimal(0.2)).setReason("discount").setTaxPercent(new BigDecimal(16)))
						.addCashDiscount(new CashDiscount(new BigDecimal(2), 14))
						.setDeliveryDate(sdf.parse("2020-11-02")).setNumber(number)
						.setVATDueDateTypeCode(EventTimeCodeTypeConstants.PAYMENT_DATE));
			} catch (ParseException e) {
				e.printStackTrace();
			}
		...
		assertFalse(zi.getUTF8().contains("<ram:IBANID>")); // maybe add a direct debit mandate to the class in the future
																												// then this would fail
		assertTrue(zi.getUTF8().contains("Hinterhaus"));
		assertThat(zi.getUTF8())
				.valueByXPath("//*[local-name()='BuyerTradeParty']/*[local-name()='GlobalID'][@schemeID=0088]").asString()
				.isEqualTo("4304171000002");
		assertThat(zi.getUTF8())
				.valueByXPath("//*[local-name()='SpecifiedTradeProduct']/*[local-name()='GlobalID'][@schemeID=0160]").asString()
		...
		assertThat(zi.getUTF8()).valueByXPath("//*[local-name()='ApplicableTradeTax']/*[local-name()='DueDateTypeCode']")
				.asString().isEqualTo(EventTimeCodeTypeConstants.PAYMENT_DATE);
	...
	public void testAllowancesExport() {
		...
		try {
			...
			ze.setTransaction(new Invoice().setDueDate(new Date()).setIssueDate(new Date()).setDeliveryDate(new Date())
					...
					.setRecipient(new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "DE"))
					.setNumber(number)
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)), new BigDecimal(500.0), qty)
							.addAllowance(new Allowance(new BigDecimal(300)).setTaxPercent(new BigDecimal(19))))
	...
	public void testRelativeChargesAllowancesExport() {
		...
		try {
			...
			ze.setTransaction(new Invoice().setCurrency("CHF").setDueDate(new Date()).setIssueDate(new Date())
					...
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)), price, new BigDecimal(1.0)))
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)), price, new BigDecimal(1.0))
							.addCharge(new Charge().setPercent(new BigDecimal(50)).setTaxPercent(new BigDecimal(19))))
	...
	public void testCorrectionExport() {
		...
		try {
			...
			Invoice i = new Invoice().setIssueDate(new Date()).setDetailedDeliveryPeriod(new Date(), new Date())
					.setDeliveryDate(new Date())
					.setSender(new TradeParty(orgname, "teststr", "55232", "teststadt", "DE").addTaxID("4711").addVATID("DE0815"))
	...
	public void testCreditNoteExport() {
		...
		try {
			...
			ze.ignorePDFAErrors().load(SOURCE_PDF);
			ze.setProducer("My Application").setCreator(System.getProperty("user.name")).setZUGFeRDVersion(2);
			Invoice i = new Invoice().setIssueDate(new Date()).setDueDate(new Date())
					.setDetailedDeliveryPeriod(new Date(), new Date()).setDeliveryDate(new Date())
					.setSender(new TradeParty(orgname, "teststr", "55232", "teststadt", "DE").addTaxID("4711").addVATID("DE0815")
