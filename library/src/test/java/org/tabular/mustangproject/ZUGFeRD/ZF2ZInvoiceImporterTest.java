...
/***
 * Classname ZF2ZInvoiceImporterTest is alphabetical behind the tests which will
 * create the file
...
public class ZF2ZInvoiceImporterTest extends ResourceCase {
	...
	public void testInvoiceImportUBL() {
		...
		Invoice invoice = null;
		try {
			String xml = new String(Files.readAllBytes(expectedResult.toPath()), StandardCharsets.UTF_8).replace("\r", "")
					.replace("\n", "");
	...
	public void testZF1Import() {
		...
		ZUGFeRDInvoiceImporter zii = new ZUGFeRDInvoiceImporter(
				"./target/testout-MustangGnuaccountingBeispielRE-20171118_506zf1.pdf");
	...
	/**
	 * testing if other files embedded in pdf additionally to the invoice can be
	 * read correctly
	 */
