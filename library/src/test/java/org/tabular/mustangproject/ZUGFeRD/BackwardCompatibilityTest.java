...
import org.tabular.mustangproject.ZUGFeRD.IZUGFeRDTradeSettlementPayment;
...
/***
 * This is a test to confirm the minimum steps to implement a interface are
 * still sufficient
 *
 * @author jstaerk
 *
	...
	public void testZF1Export() {
		...
		try (InputStream SOURCE_PDF = this.getClass()
				...
				IZUGFeRDExporter ze = new ZUGFeRDExporterFromA1().setZUGFeRDVersion(1)
						.setProfile(Profiles.getByName("Extended", 1)).load(SOURCE_PDF)) {
