...
import org.tabular.mustangproject.ZUGFeRD.ZUGFeRD2PullProvider;
...
public class XRTest extends TestCase {
	...
	public void testXREdgeExport() {
		...
		Invoice i = new Invoice().setDueDate(new Date()).setIssueDate(new Date()).setDeliveryDate(new Date())
				.setSender(new TradeParty(orgname, "teststr", "55232", "teststadt", "DE").setEmail("sender@example.com")
						.addTaxID("DE4711").addVATID("DE0815")
				...
				.setRecipient(
						new TradeParty("Franz Müller", "teststr.12", "55232", "Entenhausen", "DE").setEmail("recipient@sample.org"))
				...
				.setPayee(new TradeParty().setName("VR Factoring GmbH").setID("DE813838785")
						.setLegalOrganisation(new LegalOrganisation("391200LDDFJDMIPPMZ54", "0199")))
				.embedFileInXML(fe1);
	...
	private org.tabular.mustangproject.Invoice createInvoice(TradeParty recipient) {
		String orgname = "Test company";
		String number = "123";
		String amountStr = "1.00";
		BigDecimal amount = new BigDecimal(amountStr);
		return new Invoice().setDueDate(new java.util.Date()).setIssueDate(new java.util.Date())
				.setDeliveryDate(new java.util.Date())
				...
				.addItem(new org.tabular.mustangproject.Item(
						new org.tabular.mustangproject.Product("Testprodukt", "", "C62", java.math.BigDecimal.ZERO), amount,
