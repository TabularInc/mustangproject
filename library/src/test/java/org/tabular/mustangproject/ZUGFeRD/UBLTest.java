...
import org.tabular.mustangproject.BankDetails;
import org.tabular.mustangproject.CII.CIIToUBL;
import org.tabular.mustangproject.ZUGFeRD.EinLieferscheinExporter;
	...
	public void test1Lieferschein() {
		...
		final Invoice i = new Invoice().setDueDate(new Date()).setIssueDate(new Date()).setDeliveryDate(new Date())
				...
				.setNumber("123").addItem(new Item(new Product("Testprodukt", "", "C62", BigDecimal.ZERO),
						/* price */ new BigDecimal("1.0"), /* qty */ new BigDecimal("1.0")).addReferencedLineID("A12"));
