...
public class ProfilesMinimumBasicWLTest extends TestCase {
	...
	public void testMinimumCreditNote() {
		...
		try (InputStream SOURCE_PDF = this.getClass()
			...
			/***
			 * this is a classical example of a french invoice (very low profile, siret
			 * number) and an attempt to answer stackoverflow (!)
			...
			Invoice i = new Invoice()
					...
					.setNumber(ownNumber)
					.addItem(new Item(new Product("Testprodukt", "", "C62", new BigDecimal(19)), new BigDecimal(123),
							new BigDecimal(1)))
					.setCreditNote();
			ze.setTransaction(i);
