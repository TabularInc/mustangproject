...
public class MustangReaderWriterEdgeTest extends MustangReaderTestCase {
	 ...
	 * values.
	 * As only Name Ascending is supported for Test Unit sequence, I renamed the
	 * this test-A-Import to run before
	 * testZExport
	 */
	 ...
	 * It would not make sense to have it run before the less complex importer test
	 * (which is probably redundant).
	 * As only Name Ascending is supported for Test Unit sequence, I renamed the
	 * Exporter Test test-Z-Export
	 */
	...
	/**
	 * This test is based on #testEdgeExport but test only that the
	 * PDFIdentificationSchema is present and identifies
