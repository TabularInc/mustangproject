...
import org.tabular.mustangproject.ZUGFeRD.*;
...
public class Invoice implements IExportableTransaction {
	...
	protected String documentName = null, documentCode = null, number = null, ownOrganisationFullPlaintextInfo = null,
			referenceNumber = null, shipToOrganisationID = null, shipToOrganisationName = null, shipToStreet = null,
			shipToZIP = null, shipToLocation = null, shipToCountry = null, buyerOrderReferencedDocumentID = null,
			invoiceReferencedDocumentID = null, buyerOrderReferencedDocumentIssueDateTime = null,
			ownForeignOrganisationID = null, ownOrganisationName = null, currency = null, paymentTermDescription = null;
	 ...
	 * corrected invoice, which will result in negative VAT and a negative payment
	 * amount
	 * 
	...
	/***
	 * when the order (or whatever reference in BuyerOrderReferencedDocumentID) was
	 * issued (@todo switch to date?)
	 * 
	 * @param buyerOrderReferencedDocumentIssueDateTime IssueDateTime in format
	 *                                                  CCYY-MM-DDTHH:MM:SS
	 * @return fluent setter
	 */
	...
	/***
	 * if the delivery address is not the recipient address, it can be specified
	 * here
	 * 
	...
	public boolean isValid() {
		return (dueDate != null) && (sender != null) && (sender.getTaxID() != null) && (sender.getVATID() != null)
				&& (recipient != null);
		// contact
		// this.phone = phone;
		// this.email = email;
	...
	/**
	 * adds a free text paragraph, which will become an includedNote element with
	 * explicit
