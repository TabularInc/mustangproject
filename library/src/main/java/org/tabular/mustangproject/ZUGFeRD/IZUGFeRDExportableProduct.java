...
import org.tabular.mustangproject.ZUGFeRD.model.TaxCategoryCodeTypeConstants;
...
public interface IZUGFeRDExportableProduct {
	 ...
	 * WEE week
	 *
	 * @return a UN/ECE rec 20 unit code see
	 ...
	 *
	 * @return an array containing the product classifications or {@code null} if
	 *         not set
	 */
