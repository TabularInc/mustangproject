 ...
 *
 * @see org.tabular.mustangproject.Invoice
 */
public interface IExportableTransaction {
	 ...
	 *
	 * It is written as an includedNode with subjectCode
	 * {@link org.tabular.mustangproject.SubjectCode#REG}. See also
	...
	/***
	 * payee / payment receiver, if different from seller, ram:Payee (only supported
	 * for zf2)
	 *
	 * @return the IZUGFeRDExportableTradeParty payment receiver, if different from
	 *         sellver
	 */
	...
	/**
	 * A grouping of business terms to indicate accounting-relevant free texts
	 * including a qualification of these.
	 *
	 * The information are written to the same xml nodes like {@link #getNotes()}
	 * but with explicit subjectCode.
	 * 
