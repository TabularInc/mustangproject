 ...
 *
 *********************************************************************** */
package org.tabular.mustangproject.ZUGFeRD.model;
...
public class TaxCategoryCodeTypeConstants {
	...
	public static Set<String> CATEGORY_CODES_WITH_EXEMPTION_REASON = Stream.of(INTRACOMMUNITY, REVERSECHARGE, TAXEXEMPT)
