 ...
 * e.g. Factur-X has 6 (Minimum, Basic-WL, Basic, EN16931, Extended, and
 * XRechnung),
...
public class Profile {
	 ...
	 * Contruct
	 * 
	 * @param name human readable name of the profile, also used as basis to
	 *             detemine the XMP Name
