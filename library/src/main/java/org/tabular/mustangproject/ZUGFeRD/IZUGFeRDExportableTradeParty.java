...
/**
 * Mustangproject's ZUGFeRD implementation neccessary interface for ZUGFeRD
 * exporter Licensed under the APLv2
 *
 * @author jstaerk
 * @version 2.0.0
 *          dated 2020-09-12
...
public interface IZUGFeRDExportableTradeParty {
	...
	/**
	 * URIUniversalCommunication scheme (see EAS code list of the ZUGFeRD
	 * documentation)
	...
	/**
	 * returns additional address information which is display in xml tag
	 * "LineThree"
