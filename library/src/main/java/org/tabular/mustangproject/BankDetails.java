...
public class BankDetails implements IZUGFeRDTradeSettlementPayment {
	 ...
	 * identify the IBAN. Of course you will specify your own IBAN in full length
	 * but
	 * if you deduct from a customer's account you may e.g. leave out the first or
	 * last
	...
	/***
	 * getOwn... methods will be removed in the future in favor of Tradeparty (e.g.
	 * Sender) class
	 */
	@Override
	@Deprecated
