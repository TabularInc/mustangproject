...
import org.tabular.mustangproject.ZUGFeRD.IZUGFeRDCashDiscount;
...
public class CashDiscount implements IZUGFeRDCashDiscount {
	...
	/***
	 * Create a cash discount (skonto) with the specified height in the specified
	 * period.
	 * Should someone add more period types than just "days" there
	 * is be space for a (optional) third parameter
	 *
	 * @param percent max 3 decimals "behind the dot", more precision is currently
	 *                ignored
	...
	/***
	 * since EN16931 voted not to have (or even allow) cash discounts in their core
	 * invoice the german
