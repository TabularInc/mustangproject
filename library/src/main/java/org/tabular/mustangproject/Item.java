...
import org.tabular.mustangproject.ZUGFeRD.IReferencedDocument;
...
public class Item implements IZUGFeRDExportableItem {
	 ...
	 * 
	 * @see org.tabular.mustangproject.Charge
	 ...
	 * 
	 * @see org.tabular.mustangproject.Allowance
	...
	/***
	 * adds item level references along with their typecodes and issuerassignedIDs
	 * (contract ID, cost centre, ...)
	 * 
	 * @param doc the ReferencedDocument to add
	 * @return fluent setter
	 */
