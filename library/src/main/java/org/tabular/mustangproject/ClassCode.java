...
/**
 * A schemed classification for products. The scheme can be anything defined in
 * UNTDID 7143.
 */
public class ClassCode {
	...
	/**
	 * Get the scheme (according to UNTDID 7143) that describes the value returned
	 * by {@link #getCode()},
	...
	/**
	 * Get the code that (following the scheme returned by {@link #getListID()})
