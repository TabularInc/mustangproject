...
/***
 * the linecalculator does the math within an item line, and e.g. calculates
 * quantity*price.
 *
...
public class LineCalculator {
	...
	public LineCalculator(IZUGFeRDExportableItem currentItem) {
		...
		itemTotalNetAmount = currentItem.getQuantity().multiply(getPrice())
				.divide(currentItem.getBasisQuantity(), 18, RoundingMode.HALF_UP)
