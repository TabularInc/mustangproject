...
public class XMPSchemaZugferd extends XMPSchema {
	...
	/***
	 * This is what needs to be added to the RDF metadata - basically the name of
	 * the embedded Zugferd file
	 *
	 ...
	 * @param prefix           the xml namespace prefix for the XMP, zf for ZUGFeRD,
	 *                         fx for Factur-X
	 ...
	 *                         fx for Factur-X
	 * @param filename         the filename of the invoice
	 * @param version          meta-data version to set. May be null, and then it is
	 *                         set automatically
	 */
	public XMPSchemaZugferd(XMPMetadata metadata, int zfVersion, boolean isFacturX, Profile conformanceLevel,
